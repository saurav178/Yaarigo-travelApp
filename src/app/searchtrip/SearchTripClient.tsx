// // File: src/app/searchtrip/SearchTripClient.tsx
// "use client";
...
// export default function SearchTripClient() {
...
//   useEffect(() => {
//     const t = setTimeout(() => setAppliedFilters(draftFilters), 500);
//     return () => clearTimeout(t);
//   }, [draftFilters]);

//   // 5️⃣ FETCH DATA
//   const { trips, packages, loading, error, hasFetched } = useSearchData(appliedFilters);
...
//   const noResults = hasFetched && !loading && trips.length === 0 && packages.length === 0;
...
//             </div>
//           ) : (
//             <CombinedContent trips={trips} packages={packages} loading={loading} />
//           )}
//         </main>
//       </div>
//     </div>
