...
//         return { bg: "bg-blue-100 text-blue-800 border-blue-300", avatarBg: "bg-blue-500 text-white" };
//       case "Featured Trip Leader":
//         return { bg: "bg-yellow-100 text-yellow-800 border-yellow-300", avatarBg: "bg-yellow-500 text-white" };
//       case "Trip Agency":
//         return { bg: "bg-orange-100 text-orange-800 border-orange-300", avatarBg: "bg-orange-500 text-white" };
//       default:
//         return { bg: "bg-gray-100 text-gray-800 border-gray-300", avatarBg: "bg-gray-500 text-white" };
//     }
//   };

//   const getSafeScoreStyle = (score: number) => {
//     if (score < 50) return "bg-red-100 text-red-700 border border-red-300 px-2 py-[2px] rounded-md flex items-center gap-1 text-xs";
//     if (score < 75) return "bg-yellow-100 text-yellow-800 border border-yellow-300 px-2 py-[2px] rounded-md flex items-center gap-1 text-xs";
...
//                                     unoptimized={false}
//                                   />
//                 <div className="absolute top-3 left-3 bg-green-600 text-white text-xs font-semibold px-2 py-1 rounded-full shadow-md">{trip.host.match}% Match</div>
//                 <button onClick={() => toggleLike(trip.id)} className={`absolute top-3 right-3 w-8 h-8 flex items-center justify-center rounded-full transition ${likedTrips.includes(trip.id) ? "text-rose-500" : "text-white"}`}>
//                   <FaHeart size={16} />
//                 </button>
//               </div>
...
//                   <div className="">
//                     <h2 className="text-lg font-semibold text-gray-900 leading-tight mb-1">{trip.title}</h2>
//                     <p className="text-gray-600 text-sm line-clamp-2 mb-1">{trip.description}</p>
//                   </div>
...
//                     <div className={`relative w-12 h-12 flex items-center justify-center rounded-full font-semibold text-sm border ${catStyle.avatarBg}`}>
//                       {trip.host.name.split(" ").map((n) => n[0]).join("").toUpperCase()}

//                       {trip.host.category !== "Travel Enthusiast" && (
//                         <div className="absolute -bottom-1 -right-1 bg-white rounded-full p-0.5 shadow">
//                           <PiMedalDuotone className={`${trip.host.category === "Featured Trip Leader" ? "text-yellow-500" : "text-orange-500"}`} size={12} />
//                         </div>
//                       )}
//                     </div>
...
//                         {trip.host.verified && <FaCheckCircle className="inline text-sky-500 ml-1" />}
//                       </p>

//                       <div className="flex items-center gap-2 mt-1">
//                         <div className={`flex items-center gap-1 text-xs px-2 py-0.5 rounded-md font-medium ${catStyle.bg}`}>{trip.host.category}</div>
//                         <span className={getSafeScoreStyle(trip.host.safeScore)}>
//                           <FaShieldAlt /> {trip.host.safeScore}% Safe
//                         </span>
//                       </div>

//                       <p className="text-xs text-gray-600 mt-1">{trip.host.location} • ⭐ {trip.host.rating}</p>
//                     </div>
//                   </div>
...
// /src/app/searchtrip/components/TripCard.tsx
