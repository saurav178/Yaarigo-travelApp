...
//   trips: ApiTrip[];
//   packages: ApiPackage[];
//   loading: boolean; // 👈 comes from parent
// };
...
//     Math.ceil(trips.length / TRIPS_PER_BLOCK),
//     Math.ceil(packages.length / PACKAGES_PER_BLOCK),
//     1 // 👈 ensures skeleton block exists
//   );
...
// function PackageCardSkeleton() {
//   return (
//     <div className="bg-white shadow-md overflow-hidden w-80 rounded-lg animate-pulse">
//       <div className="h-40 bg-gray-200" />
