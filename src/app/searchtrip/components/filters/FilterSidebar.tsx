...
//       {/* Gradient divider */}
//       <div className="absolute top-0 right-0 h-full bg-gradient-to-b from-[#1d4350] via-[#2d5560] to-transparent" />

//       {/* Header with gradient background */}
//       <div className="sticky top-0 z-10 px-6 pt-8 pb-6 bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#2c5364]">
...
//             className="px-3 py-1.5 text-xs font-medium text-white bg-[#1d4350]/80 hover:bg-[#1d4350] backdrop-blur-sm rounded-lg transition-all flex items-center gap-1.5"
//           >
...
const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  /* =============================== UI =============================== */
  return (
    <div className="relative bg-white shadow-lg overflow-hidden rounded-xl">
