...
export default function Sidebar() {
  ...
  // Tabs
  const tabs: Array<{ key: TabKey; label: string; icon: React.ReactElement }> = useMemo(
    () => [
  ...
  const go = useCallback(
    (key: TabKey) => {
      ...
      if (key === "qa") setShowChat((prev) => !prev); // keep your chat toggle behavior
    },
    [router, search]
  );
  ...
  // Only AI panels render content in sidebar.
  // LIVE panel is intentionally disabled → handled by feed on page.tsx
  const renderPanel = () => {
    if (active === "ai-spam") {
      return (
      ...
      <aside className="bg-white border border-neutral-200 p-4 shadow-sm sticky top-4">
        ...
        <div className="mt-4 bg-neutral-50 border border-neutral-200 rounded-md p-5">
          <div className="flex items-center justify-between mb-3">
            <h4 className="font-semibold text-sm text-neutral-900 flex items-center gap-2">🏆 Gamification</h4>
          ...
          <div className="mb-5">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center justify-between bg-white border border-neutral-200 rounded-md px-3 py-2">
                ...
                <button className="text-xs px-2 py-1 rounded bg-blue-500 text-white hover:bg-blue-600">Mark done</button>
              </li>
              <li className="flex items-center justify-between bg-white border border-neutral-200 rounded-md px-3 py-2">
                <span className="flex items-center gap-2">
                  <span className="inline-block w-4 h-4 rounded border border-neutral-300 bg-neutral-50"></span>
                ...
                <button className="text-xs px-2 py-1 rounded bg-blue-500 text-white hover:bg-blue-600">Track</button>
              </li>
              <li className="flex items-center justify-between bg-white border border-neutral-200 rounded-md px-3 py-2">
                <span className="flex items-center gap-2">
                  <span className="inline-block w-4 h-4 rounded border border-neutral-300 bg-neutral-50"></span>
                ...
                <button className="text-xs px-2 py-1 rounded bg-blue-500 text-white hover:bg-blue-600">Explore</button>
              </li>
            </ul>
          </div>
          <div>
