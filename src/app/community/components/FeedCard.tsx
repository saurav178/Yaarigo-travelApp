...
//   return (
//     <article className="bg-white border border-neutral-200 p-5 shadow-soft hover:shadow-md transition-all duration-200 -mt-5 w-full">
  ...
  return (
    <article className="bg-white border border-neutral-200  p-5 shadow-sm hover:shadow-md transition-all duration-200 w-full">
      <div className="flex items-start justify-between gap-4">
        ...
        {/* Image */}
        <div className="relative shrink-0 w-36 h-28 sm:w-44 sm:h-32 overflow-hidden border border-neutral-200 bg-neutral-100 ">
          {post.imageUrl ? (
            <Image
              src={post.imageUrl}
              alt={post.location}
