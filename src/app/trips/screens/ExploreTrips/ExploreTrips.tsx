...
export default function ExploreTrips() {
  ...
  const filteredTrips = exploreTrips.filter((trip) => {
    ...
    return (
      matchesSearch && matchesSeason && matchesAvailability && matchesRating
    );
  });
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
        <h2 className="text-2xl font-bold text-blue-500">Explore Trips</h2>
        ...
        <div className="flex items-center gap-2 relative">
          ...
          {showFilters && (
            <div
              ref={filterRef}
              className="absolute top-full mt-2 right-0 bg-white border border-gray-200 rounded-2xl shadow-xl p-5 w-80 z-50"
            >
                    ...
                    {["Best Time to Visit", "Okay to Visit", "Too Crowded"].map((s) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() => handleCheckboxChange(setSelectedSeasons, selectedSeasons, s)}
                    ...
                    {["Available", "Limited", "Fully Booked"].map((a) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() => handleCheckboxChange(setSelectedAvailability, selectedAvailability, a)}
                          className="accent-blue-500 w-4 h-4"
                        />
                        {a}
                      </label>
                    ...
                    {[5, 4, 3, 2, 1].map((r) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() => handleCheckboxChange(setSelectedRatings, selectedRatings, r)}
                          className="accent-blue-500 w-4 h-4"
                        />
                        {r} ⭐ & up
                      </label>
