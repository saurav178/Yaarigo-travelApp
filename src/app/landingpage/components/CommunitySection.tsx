...
export default function CommunitySection({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000" />
      <div className="absolute bottom-0 left-1/2 w-64 h-64 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000" />

      <div className="relative z-10">
        <div className="text-center mb-12">
          <h2 className="relative inline-block text-3xl font-bold text-gray-900 mb-4">
            Join Our Global Community
            <span
              className={`absolute left-1/2 bottom-[-8px] h-[4px] rounded-full transition-all duration-700 ${
                isVisible ? "w-[150%]" : "w-0"
              }`}
              style={{
                transform: "translateX(-50%)",
        ...
        <div className="grid md:grid-cols-2 gap-3 max-w-6xl mx-auto mb-10">
          {(communityTestimonials as CommunityTestimonial[]).map((review, i) => (
            <div key={i} className="group relative overflow-hidden">
              <div
                className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm"
                style={{
              ...
              <div className="relative bg-white p-5 shadow-lg hover:shadow-2xl transition-all duration-500 m-0.5">
                ...
                <div className="flex items-center gap-3 mb-3 pt-2">
                  <div
                    className={`w-12 h-12 rounded-full bg-gradient-to-br ${review.gradient} text-white flex items-center justify-center font-bold text-sm`}
                  >
                    {review.initials}
                  </div>
        ...
        <div className="max-w-6xl mx-auto mt-16">
          <div className="shadow-xl p-4 md:p-6 -mt-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12">
              {(communityStats as CommunityStat[]).map((stat, i) => (
