...
import { FaChevronLeft, FaChevronRight, FaStar, FaCircle, FaRegCircle, FaRupeeSign, FaCheckCircle } from "react-icons/fa";
import { travelers } from "../data/profileData";

export default function FeaturedTripLeaderSection() {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto mt-10 px-4">
      ...
      <div className="grid grid-cols-4 gap-6">
        {travelers.slice(0, 1).map((t: any, index: number) => (
          <div
            key={index}
          ...
          >
            ...
            <div className="p-2">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {t.tags.slice(0, 3).map((tag: string, i: number) => (
                  <span
                    key={i}
