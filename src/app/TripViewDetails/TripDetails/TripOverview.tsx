...
export default function TripOverview({ trip }: TripProps) {
  ...
  const travelStyle =
    trip?.partnerPreferences?.travelMode ?? "N/A";

  const languages =
    trip?.partnerPreferences?.languages ?? [];

  const splitCost =
    trip?.partnerPreferences?.costPreference === "SHARE";

  const lookingFor =
    trip?.partnerPreferences?.genderPreference ?? "ANY";

  const foodPreference =
    trip?.partnerPreferences?.foodPreference ?? "N/A";
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6 text-sm justify-center">
        ...
        <div className="bg-gray-100 p-3 flex flex-col justify-between max-w-45 mx-auto">
          <div className="flex items-center gap-2">
            <img src="/icon/ic_baseline-route.png" alt="route" className="w-5 h-5" />
        ...
        <div className="bg-gray-100 p-3 flex flex-col justify-between max-w-45 mx-auto">
          <div className="flex items-center gap-2">
            <img src="/icon/iconoir_wallet-solid.png" alt="budget" className="w-5 h-5" />
        ...
        <div className="bg-gray-100 p-3 flex flex-col justify-between max-w-45 mx-auto">
          <div className="flex items-center gap-2">
            <img src="/icon/ix_user-management-filled.png" alt="travelers" className="w-5 h-5" />
...
<div className="flex-1 flex flex-col gap-4 ml-12">
  ...
  <Info label="Duration" value={duration} />
    ...
    {/* RIGHT COLUMN (shifted slightly right) */}
