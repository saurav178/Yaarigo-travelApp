...
function PackageDetailsCard({ packageTitle, fromLocation, toLocation, duration, planName }: PackageDetailsCardProps) {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
      <div className="flex flex-col md:flex-row justify-between gap-6">
        <div className="flex-1">
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-50 text-[#276074] text-xs font-bold uppercase tracking-wider mb-3">
            {planName}
          </div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{packageTitle}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-center gap-3 text-gray-600">
              <MapPin className="w-5 h-5 text-[#276074]" />
              <span>{fromLocation} to {toLocation}</span>
            </div>
            <div className="flex items-center gap-3 text-gray-600">
