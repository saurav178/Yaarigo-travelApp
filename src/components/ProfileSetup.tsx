...
// export default function ProfileSetup({ onProfileSave, error }: Props) {
...
//     >
//       <div className="w-full max-w-3xl bg-white/85 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-gray-300">
